...
impl ClanSearchOptionsBuilder {
    ...
    #[must_use] pub fn max_members(mut self, max_members: i32) -> Self {
        if max_members <= 50 {
    ...
    #[must_use] pub fn min_clan_points(mut self, min_clan_points: i32) -> Self {
        self.options.min_clan_points = Some(min_clan_points);
        self.options.items[5] = ("minClanPoints".to_string(), min_clan_points.to_string());
        self
    }
    #[must_use] pub fn min_clan_level(mut self, min_clan_level: i8) -> Self {
        if min_clan_level >= 2 {
